// ======================================================================
// DigitalUtilityExample01.v generated from TopDesign.cysch
// 03/21/2019 at 18:07
...
module top ;
	...
	cy_clock_v1_0
		#(.id("12919d07-52a4-4dc8-af07-81310428743c"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    assign Net_413 = Net_414 & Net_412;


    assign Net_414 = ~Net_140;
    ...
    UART_v2_50_0 screen (
        ...
        .reset(1'b0),
        .rx(Net_438),
        .tx_interrupt(Net_439),
        .rx_interrupt(Net_440),
        .tx_data(Net_441),
        .tx_clk(Net_442),
        .rx_data(Net_443),
        .rx_clk(Net_444));
